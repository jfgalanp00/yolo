...
cap = cv2.VideoCapture('https://plataforma.caceres.es/streaming/ayuntamiento')
...
while True:
    ...
    # Abajo izqda, Arriba izqda,
    area_pts = np.array([[0, frame.shape[0]], [900, frame.shape[0] - 800], [frame.shape[1]-700, frame.shape[0] - 800], [frame.shape[1]-200, frame.shape[0]]])
